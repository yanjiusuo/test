...
import com.jd.workflow.soap.common.util.ArrayHelper;
import com.jd.workflow.soap.common.util.CollectionHelper;
...
public class ObjectTypes {
    ...
    public static Object convert(Object value, Class<?> type) {
        if (value == null) {
            ...
            if (convertValue == null && !(value instanceof String && ((String) value).isEmpty())) {
    ...
    static {
        ...
        extensionObjectTypes = new ConcurrentHashMap<>(100);
    }
