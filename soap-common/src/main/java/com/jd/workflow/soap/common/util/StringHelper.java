...
import com.jd.workflow.soap.common.lang.IRandom;
...
public class StringHelper {
    ...
    static Pattern VAR_NAME_EXPR = Pattern.compile("^[a-z_A-Z][a-zA-Z0-9_]*$");
    ...
    public static final String camelCaseByChars(String str, String chars, boolean firstUpper) {
        if (str != null && !str.isEmpty()) {
            str = str.toLowerCase();
            StringBuilder sb = new StringBuilder();
            boolean matchSeparator = false;
            char firstChar;
            if (str.length() > 1 &&  chars.indexOf(str.charAt(1)) != -1) {
    ...
    public static final String camelCase(String str, char separator, boolean firstUpper) {
         return camelCaseByChars(str,separator+"",firstUpper);
    }
    ...
    public static String markQuery(Map<String, ?> query) {
        if (query == null) {
            return null;
    ...
    public static String replacePlaceholder(String s,Map<String,Object> args){
        if(s == null || args == null) return s;
        for (Map.Entry<String, Object> entry : args.entrySet()) {
            String value = "";
            if(entry.getValue()!=null){
                value = entry.getValue().toString();
            }
            s = StringUtils.replace(s,"{"+entry.getKey()+"}",value);
        }
        return s;
    }
    public static boolean isValidVarName(String varName){
        if(StringUtils.isEmpty(varName)) return false;
        return VAR_NAME_EXPR.matcher(varName).matches();
    }
    public static String camelParamName(String paramName){
        return camelParamName(paramName,false);
    }

    public static String camelParamName(String paramName,boolean firstUpper){
        paramName = StringHelper.camelCaseByChars(paramName,"-_",firstUpper);
        return paramName;
    }
    ...
    public static void main(String[] args) {
        System.out.println(camelParamName("X_token-id"));
