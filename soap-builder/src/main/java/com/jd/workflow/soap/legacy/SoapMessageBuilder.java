...
import com.jd.workflow.soap.annotation.ThreadSafe;
...
public class SoapMessageBuilder {
    ...
    public SoapMessageBuilder(Definition definition) throws WSDLException {
        WSDLReader reader = new WSDLReaderImpl();
        reader.setFeature("javax.wsdl.verbose", false);
    ...
    public String buildSoapMessageFromInput(Binding binding, BindingOperation bindingOperation, SoapContext context) throws Exception {
        ...
        XmlObject object = buildSoapMessageFromInputXmlObj(binding, bindingOperation, context);
    ...
    public XmlObject buildSoapMessageFromInputXmlObj(Binding binding, BindingOperation bindingOperation, SoapContext context) throws Exception {
    ...
    public String buildSoapMessageFromOutput(Binding binding, BindingOperation bindingOperation, SoapContext context) throws Exception {
        ...
        XmlObject object = buildSoapMessageFromOutputXmlObj(binding, bindingOperation, context);
    ...
    public XmlObject buildSoapMessageFromOutputXmlObj(Binding binding, BindingOperation bindingOperation, SoapContext context) throws Exception {
        boolean inputSoapEncoded = WsdlUtils.isInputSoapEncoded(bindingOperation);
        SampleXmlUtil xmlGenerator = new SampleXmlUtil(inputSoapEncoded, context);
        SoapVersion soapVersion = getSoapVersion(binding);
