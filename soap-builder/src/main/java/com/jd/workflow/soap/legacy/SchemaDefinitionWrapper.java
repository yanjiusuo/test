...
public class SchemaDefinitionWrapper {
    ...
    public SchemaDefinitionWrapper(Definition definition, String schemaURL) {
        ...
        //String content = WsdlUtils.wsdlToString(def)
    ...
    public SchemaDefinitionWrapper(Definition definition) {
        ...
        loadSchemaTypesByContent(new UrlSchemaLoader(definition));
    }
    ...
    public void loadSchemaTypesByContent(UrlSchemaLoader loader) {

        String xml = Wsdl11Writer.wsdlToString(loader.getDefinition());
        schemaTypes = SchemaUtils.loadSchemaTypesByWsdlContent(xml, loader);
        schemaTypeLoader = XmlBeans.typeLoaderUnion(new SchemaTypeLoader[]{schemaTypes,
                XmlBeans.getBuiltinTypeSystem()});
    }
