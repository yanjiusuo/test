...
import com.jd.workflow.soap.SoapException;
...
public class Wsdl11Writer {
    static final Logger logger = LoggerFactory.getLogger(Wsdl11Writer.class);
    ...
    public static String wsdlToString(Definition def){
        ...
        try {
            ...
            throw new StdException("wsdl.err_generate_wsdl",e);
        }
