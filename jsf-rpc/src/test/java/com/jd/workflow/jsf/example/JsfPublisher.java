...
import com.jd.workflow.jsf.service.test.PersonServiceImpl;
...
public class JsfPublisher {
    ...
    public final static void main(String[] args) throws InterruptedException {
      ...
      /*  serverConfig.setHost(JSFContext.getLocalHost()); // 获取本机ip；
        ...
        ProviderConfig<IPersonService> providerConfig = new ProviderConfig<>();
        providerConfig.setInterfaceId("com.jd.workflow.jsf.service.test.IPersonService");
        providerConfig.setAlias("center");

        providerConfig.setParameter(".token","123456");

        providerConfig.setServer(serverConfig);
        providerConfig.setRef(new PersonServiceImpl());
        //重要的：发起注册请求
