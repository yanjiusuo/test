package com.jd.workflow.soap.example.jsf;
...
import com.jd.workflow.soap.example.jsf.entity.IUserService;
import com.jd.workflow.soap.example.jsf.entity.UserServiceJImpl;
...
public class JsfPublisher {
    ...
    public final static void main(String[] args) throws InterruptedException {
      ...
      /*  serverConfig.setHost(JSFContext.getLocalHost()); // 获取本机ip；
        ...
        providerConfig.setAlias("center122");
