...
import com.jd.workflow.soap.example.webservice.model.FullTyped;
import com.jd.workflow.soap.example.webservice.model.RoleInfo;
import com.jd.workflow.soap.example.webservice.model.SimpleTyped;
...
public class FullTypedWebService {
    ...
    public String test1(String str1, String typed){
    ...
    @WebResult(name = "typed")
    public  void exception(int a) throws NullPointerException,IllegalArgumentException {
        if(a==1){
    ...
    public RoleInfo queryRole(@WebParam(name="roleName") String roleName){
        ...
        roleInfo.setCreateDate(format.format(new Date()));
        return roleInfo;
    }
     ...
     */
    public static void  run(BiFunction callback,String address){
    ...
    public static void main(String[] args) {
        run(null,"http://0.0.0.0:7001/FullTypedWebService");
    }
}
