...
import com.jd.workflow.console.listener.cjg.processor.CjgAppMemberProcessor;
...
@Slf4j
public class CjgAppMemberListener implements MessageListener {
    @Autowired
    CjgAppMemberProcessor processor;
    @Override
    public void onMessage(List<Message> list) throws Exception {
        log.info("cjg.app_member_info_message_size={}",list.size());
