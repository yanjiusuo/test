...
import com.jd.workflow.console.interceptor.DataContextInterceptor;
import com.jd.workflow.console.interceptor.UserInfoInterceptor;
import lombok.Data;
...
public class WebConfiguration implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(new DataContextInterceptor());
    }
   /*@Bean
...
//    }
    ...
    @Bean
    public FilterRegistrationBean<Filter> corsFilter(CorsProperties corsProperties) {
        UrlBasedCorsConfigurationSource source = new UrlBasedCorsConfigurationSource();
        source.registerCorsConfiguration(corsProperties.getPath(), corsProperties.getConfiguration());
